...
// SIENNA.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CSIENNAApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CSIENNAApp

CSIENNAApp::CSIENNAApp()
{
...
// El único objeto CSIENNAApp

CSIENNAApp theApp;


// Inicialización de CSIENNAApp

BOOL CSIENNAApp::InitInstance()
{
